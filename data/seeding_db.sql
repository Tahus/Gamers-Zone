...
( 'Nouveautès De La Semaine', 'Tu retrouveras ici toutes les nouvelles sorties de la semaine', 'https://www.pexels.com/fr-fr/photo/homme-jouer-technologie-debout-7915414/' ),
( 'Jeux Solo', 'tu cherches des jeux en solo? Tu es au bon endroit.', 'https://www.pexels.com/fr-fr/photo/homme-technologie-montre-neon-7360387/'),
( 'Populaires', 'Cette section regroupe les jeux les plus populaires de ces dernières années, jettes-y un oeil.', 'https://www.pexels.com/fr-fr/photo/moniteur-d-ordinateur-a-ecran-plat-3977908/'),
( 'Multijoueurs', 'Ici sont regroupès les jeux auxquels tu pourras jouer avec tes amis en ligne ou en local, tu trouveras sûrement ton bonheur !', 'https://www.pexels.com/fr-fr/photo/amis-hommes-etre-assis-jouer-7915520/'),
( 'Action', 'Si tu es du genre à tirer sur tout ce qui bouge, tu es tombé sur la bonne catégorie.', 'https://www.pexels.com/fr-fr/photo/paysage-homme-gens-femme-7047538/'),
('Sport', 'Quoi de plus important que le sport? eh bien les jeux de sport tiens !', 'https://www.pexels.com/fr-fr/photo/deux-personnes-tenant-des-consoles-de-jeu-noires-442576/');

INSERT INTO "articles" ("title", "description", "url_image", "media_type"  ) VALUES
...
( 'Alfred', 'a.martin@gamer.com', '08/12/1988', '12345', 'https://pixabay.com/fr/vectors/homme-personne-avatar-visage-156584/'),
('Gaara', 'g.chunin@gamer.com','12/09/2002', '12345', 'https://pixabay.com/fr/illustrations/naruto-ninja-gar%c3%a7on-jeune-gaara-6383641/'),
('Selena', 's.lorano@gamer.com','10/02/1999', '12345', 'https://pixabay.com/fr/illustrations/femme-beaut%c3%a9-dessin-anim%c3%a9-avatar-6616607/'),
('Valérie', 'v.prune@gamer.com','13/07/2000', '12345', 'https://pixabay.com/fr/vectors/avatar-dessin-anim%c3%a9-les-yeux-femme-2026510/');
